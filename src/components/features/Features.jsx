...
export default function Features() {
    const stack = [
        { id: 1, content: "Macam Reddit, Facebook, dan Quora tapi diutamakan untuk Bahasa Melayu dan orang Malaysia, sambil mengekalkan fleksibiliti Bahasa Inggeris.", imageName: "chair.jpg" },
